/**
 * Canonical IS-Commercial complexity multipliers (prompt 10).
 * Rates are decimals (0.08 = 8%), not integer percents.
 * Descriptions are the CSV "Notes and Rules" text verbatim.
 */
import type { ComplexityCategory } from "@prisma/client";

export type IsComComplexitySeed = {
  name: string;
  slug: string;
...
export const IS_COM_COMPLEXITY_MULTIPLIERS: IsComComplexitySeed[] = [
  {

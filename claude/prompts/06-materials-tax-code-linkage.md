...
The case is **Security Equipment Supply, Inc. v. Richard H. Roberts, Commissioner of Revenue** (Tenn. Ct. App. Nov. 28, 2016, No. M2016-00423-COA-R3-CV) — confirmed by reading the actual opinion, not assumed. One caveat on top of it: a second source Ryan pointed to (a 2017 TN Alarm Systems Contractors Board meeting-minutes PDF) couldn't be retrieved in this environment (no browser access, and the PDF wouldn't render through the fetch tool) — if it says something that changes this classification, that still needs a manual read.
